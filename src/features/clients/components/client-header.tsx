...
const statLinkClassName =
  'min-w-0 rounded-lg px-1 py-2 hover:bg-accent hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring sm:px-2';
...
export function ClientHeader({
  ...
  return (
    <section className="min-w-0 rounded-xl border bg-card p-4 sm:p-5">
      ...
      <div className="mt-4 grid grid-cols-3 gap-1 text-xs sm:gap-2 sm:text-sm">
        <a href="#conversaciones" className={statLinkClassName}>
          <span className="block leading-tight text-muted-foreground">Conversaciones</span>
          <span className="font-medium">{client.interactionCount}</span>
        </a>
        <a href="#pedidos" className={statLinkClassName}>
          <span className="block leading-tight text-muted-foreground">Pedidos</span>
          <span className="font-medium">{client.orderCount}</span>
        </a>
        <a href="#tareas" className={statLinkClassName}>
          <span className="block leading-tight text-muted-foreground">Tareas abiertas</span>
          <span className="font-medium">{client.openTaskCount}</span>
        </a>
      </div>
